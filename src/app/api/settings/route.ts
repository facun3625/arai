...
export async function POST(request: Request) {
    try {
        ...
        const updateData: any = {
            ...
            ...(body.ocaOriginStreet !== undefined && { ocaOriginStreet: parseStr(body.ocaOriginStreet) }),
            ...(body.ocaOriginNumber !== undefined && { ocaOriginNumber: parseStr(body.ocaOriginNumber) }),
            ...(body.ocaOriginFloor !== undefined && { ocaOriginFloor: parseStr(body.ocaOriginFloor) }),
            ...(body.ocaOriginCity !== undefined && { ocaOriginCity: parseStr(body.ocaOriginCity) }),
            ...(body.ocaOriginProvince !== undefined && { ocaOriginProvince: parseStr(body.ocaOriginProvince) }),
            ...(body.ocaOriginContact !== undefined && { ocaOriginContact: parseStr(body.ocaOriginContact) }),
            ...(body.ocaOriginEmail !== undefined && { ocaOriginEmail: parseStr(body.ocaOriginEmail) }),
            ...(body.ocaFranjaHoraria !== undefined && { ocaFranjaHoraria: parseStr(body.ocaFranjaHoraria) }),
            ...(body.ocaUser !== undefined && { ocaUser: parseStr(body.ocaUser) }),
            ...(body.ocaPassword !== undefined && { ocaPassword: parseStr(body.ocaPassword) }),
            ...(body.ocaNroCliente !== undefined && { ocaNroCliente: parseStr(body.ocaNroCliente) }),
