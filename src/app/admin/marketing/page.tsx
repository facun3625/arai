...
import { Plus, Trash2, Edit2, CheckCircle2, XCircle, Save, Percent, DollarSign, Tag } from "lucide-react";
...
export default function MarketingPage() {
    ...
    const handleDeleteCoupon = async (id: string) => {
        ...
        try {
            ...
            if (res.ok) {
                showToast("Cupón eliminado a la papelera 🗑️", "success");
                fetchCoupons();
            }
        } catch (error) {
            ...
            <div className="space-y-8 animate-in fade-in duration-700">
                ...
                <div className="flex items-center justify-between">
                    <div className="flex flex-col gap-1">
                        ...
                        <p className="text-white/40 text-[11px] uppercase tracking-widest">envío gratis y cupones de descuento</p>
                    </div>
                </div>
